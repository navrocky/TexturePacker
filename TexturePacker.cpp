...
public:
  ...
  virtual bool packTextures(int &width,int &height,bool forcePowerOfTwo,bool onePixelBorder, int& unused)  // pack the textures, the return code is the amount of wasted/unused area.
  {
//    width = 0;
//    height = 0;
...
//      height = nextPow2(height);
    ...
    unused = (width*height)-mTotalArea;
    return true;
  }
